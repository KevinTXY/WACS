$( document ).ready(function() {
    ...
    $('a:contains(gun)').each(function(){
        $(this).css({"color": "transparent", "text-shadow": "0 0 30px rgba(0,0,0,1)"});
    });
    $('p:contains(knife)').each(function(){
        $(this).css({"color": "transparent", "text-shadow": "0 0 30px rgba(0,0,0,1)"});
    });

    $('a:contains(knife)').each(function(){
        $(this).css({"color": "transparent", "text-shadow": "0 0 30px rgba(0,0,0,1)"});
    });
    $('p:contains(drug)').each(function(){
        $(this).css({"color": "transparent", "text-shadow": "0 0 30px rgba(0,0,0,1)"});
    });

    $('a:contains(drug)').each(function(){
        $(this).css({"color": "transparent", "text-shadow": "0 0 30px rgba(0,0,0,1)"});
    });
    $('p:contains(blood)').each(function(){
        $(this).css({"color": "transparent", "text-shadow": "0 0 30px rgba(0,0,0,1)"});
    });

    $('a:contains(blood)').each(function(){
        $(this).css({"color": "transparent", "text-shadow": "0 0 30px rgba(0,0,0,1)"});
    });
    $('p:contains(rifle)').each(function(){
        $(this).css({"color": "transparent", "text-shadow": "0 0 30px rgba(0,0,0,1)"});
    });
    ...
    $('h1:contains(gun)').each(function(){
        $(this).css({"color": "transparent", "text-shadow": "0 0 30px rgba(0,0,0,1)"});
    });
    $('h1:contains(knife)').each(function(){
          $(this).css({"color": "transparent", "text-shadow": "0 0 30px rgba(0,0,0,1)"});
        });
    $('h1:contains(drug)').each(function(){
          $(this).css({"color": "transparent", "text-shadow": "0 0 30px rgba(0,0,0,1)"});
        });
    $('h1:contains(blood)').each(function(){
          $(this).css({"color": "transparent", "text-shadow": "0 0 30px rgba(0,0,0,1)"});
        });
    $('h1:contains(rifle)').each(function(){
          $(this).css({"color": "transparent", "text-shadow": "0 0 30px rgba(0,0,0,1)"});
        });
    $('h1:contains(Gun)').each(function(){
          $(this).css({"color": "transparent", "text-shadow": "0 0 30px rgba(0,0,0,1)"});
...
$('h1:contains(gun)').mouseenter(function(){
    $(this).css({"color": "black", "text-shadow": "none"});
})

$('h1:contains(gun)').mouseleave(function(){
    $(this).css({"color": "transparent", "text-shadow": "0 0 30px rgba(0,0,0,1)"});
})
$('h1:contains(knife)').mouseenter(function(){
    $(this).css({"color": "black", "text-shadow": "none"});
})

$('h1:contains(knife)').mouseleave(function(){
    $(this).css({"color": "transparent", "text-shadow": "0 0 30px rgba(0,0,0,1)"});
})
$('h1:contains(drug)').mouseenter(function(){
    $(this).css({"color": "black", "text-shadow": "none"});
})

$('h1:contains(drug)').mouseleave(function(){
    $(this).css({"color": "transparent", "text-shadow": "0 0 30px rgba(0,0,0,1)"});
});
$('h1:contains(blood)').mouseenter(function(){
    $(this).css({"color": "black", "text-shadow": "none"});
})

$('h1:contains(blood)').mouseleave(function(){
    $(this).css({"color": "transparent", "text-shadow": "0 0 30px rgba(0,0,0,1)"});
})
$('h1:contains(rifle)').mouseenter(function(){
    $(this).css({"color": "black", "text-shadow": "none"});
})
